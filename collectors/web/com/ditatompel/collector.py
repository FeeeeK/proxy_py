...
#         ips = tree.xpath(
#             "//table[@id='proxyList']//tbody/tr/td[position() mod 6 = 1]/text()"
#         )
#         ports = tree.xpath(
#             "//table[@id='proxyList']//tbody/tr/td[position() mod 6 = 1]/span/text()"
#         )
#         type_ = tree.xpath(
...
#         return [
#             str(type_[i] + "://" + ips[i] + ports[i])
#             for i in range(0, len(type_) - 1, 1)
#         ]  # if country[i] != 'RU'
...
#             url = (
#                 self.url.split("url")[0]
#                 + script
#                 + _script
#                 + "url"
#                 + self.url.split("url")[1]
#             )
...
#             "http://localhost:8050/render.html?wait=5&filters=none&timeout=15&url=https://www.ditatompel.com/proxy/anonymity/anon",
#             2,
#         )
